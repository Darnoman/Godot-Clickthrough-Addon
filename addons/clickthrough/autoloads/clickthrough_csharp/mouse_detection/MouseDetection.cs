...
public partial class MouseDetection : Node
{
	...
	private ClickthroughCSharp Clickthrough;

	[Export]
	public bool UseDefaultDetectPassthrough = true;

	public override void _Ready()
	{
		Clickthrough = GetParent<ClickthroughCSharp>();
	...
	{
		if (UseDefaultDetectPassthrough)
		{
			DetectPassthrough();
		}
	}
	...
	private void SetClickability(bool clickable)
	{
		if (clickable != _clickthrough)
		{
			...
			Clickthrough.SetClickThrough(!clickable);
		}
	}

	public void SetUseDefaultDetectPassthrough(bool value)
	{
		UseDefaultDetectPassthrough = value;
	}
}
